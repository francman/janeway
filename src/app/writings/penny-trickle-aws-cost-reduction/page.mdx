...
export const article = {
  ...
  description:
    'I almost had to reduce my beer budget, but then, I remembered all the talk about AWS Optimization and how AWS is helping customers save cost. I almost had to reduce my beer budget, but then, I remembered all the talk about AWS Optimization and how AWS is helping customers save cost.',
};
