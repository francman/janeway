...
export function BookCard<T extends React.ElementType = 'div'>({
  as,
  className,
  children,
...
BookCard.Link = function BookCardLink({
  children,
  ...props
...
BookCard.Title = function BookCardTitle<T extends React.ElementType = 'h2'>({
  as,
  href,
  children,
  ...
  return (
    <Component className="text-base font-semibold tracking-tight text-zinc-800 dark:text-zinc-100">
      {href ? <BookCard.Link href={href}>{children}</BookCard.Link> : children}
    </Component>
  )
}

BookCard.Description = function CardDescription({
  children,
}: {
...
BookCard.Cta = function CardCta({ children }: { children: React.ReactNode }) {
  return (
    <div
      aria-hidden="true"
...
BookCard.Eyebrow = function CardEyebrow<T extends React.ElementType = 'p'>({
  as,
  decorate = false,
  className,
  children,
